...
const uint8_t font4_8[][4] = {
0x00,0x00,0x00,0x00,/*" ",0*/
0x00,0x00,0x5E,0x00,/*"!",1*/
0x00,0x04,0x06,0x02,/*""",2*/
0x24,0x3C,0x24,0x3C,/*"#",3*/
0x00,0x4C,0xFE,0x00,/*"$",4*/
0x1E,0x7A,0x5E,0x78,/*"%",5*/
0x70,0x5E,0x3E,0x48,/*"&",6*/
0x00,0x06,0x00,0x00,/*"'",7*/
0x00,0x00,0x7C,0x82,/*"(",8*/
0x42,0x3C,0x00,0x00,/*")",9*/
0x18,0x10,0x3C,0x18,/*"*",10*/
0x10,0x10,0x7C,0x10,/*"+",11*/
0x00,0xC0,0x00,0x00,/*",",12*/
0x10,0x10,0x10,0x10,/*"-",13*/
0x00,0x40,0x00,0x00,/*".",14*/
0x80,0x70,0x1C,0x02,/*"/",15*/
0x38,0x44,0x38,0x00,/*"0",16*/
0x00,0x44,0x7C,0x40,/*"1",17*/
0x6C,0x54,0x4C,0x00,/*"2",18*/
0x44,0x54,0x6C,0x00,/*"3",19*/
0x30,0x68,0x7C,0x60,/*"4",20*/
0x4C,0x4C,0x7C,0x00,/*"5",21*/
0x78,0x4C,0x7C,0x00,/*"6",22*/
0x00,0x04,0x7C,0x00,/*"7",23*/
0x6C,0x54,0x6C,0x00,/*"8",24*/
0x5C,0x54,0x3C,0x00,/*"9",25*/
0x00,0x00,0x48,0x00,/*":",26*/
0x00,0x00,0xC8,0x00,/*";",27*/
0x00,0x18,0x24,0x42,/*"<",28*/
0x18,0x18,0x18,0x18,/*"=",29*/
0x00,0x42,0x24,0x18,/*">",30*/
0x00,0x0C,0x54,0x0C,/*"?",31*/
0x3C,0x7A,0x76,0x7C,/*"@",32*/
0x40,0x38,0x38,0x40,/*"A",33*/
0x44,0x7C,0x7C,0x00,/*"B",34*/
0x38,0x44,0x44,0x00,/*"C",35*/
0x44,0x7C,0x38,0x00,/*"D",36*/
0x00,0x7C,0x7C,0x00,/*"E",37*/
0x40,0x7C,0x7C,0x00,/*"F",38*/
0x38,0x64,0x64,0x20,/*"G",39*/
0x00,0x7C,0x7C,0x00,/*"H",40*/
0x00,0x44,0x7C,0x44,/*"I",41*/
0x80,0x84,0xFC,0x04,/*"J",42*/
0x00,0x7C,0x44,0x00,/*"K",43*/
0x40,0x7C,0x44,0x00,/*"L",44*/
0x7C,0x60,0x7C,0x00,/*"M",45*/
0x40,0x7C,0x7C,0x04,/*"N",46*/
0x38,0x44,0x38,0x00,/*"O",47*/
0x40,0x7C,0x5C,0x00,/*"P",48*/
0x38,0x64,0xF8,0x00,/*"Q",49*/
0x00,0x7C,0x3C,0x40,/*"R",50*/
0x4C,0x54,0x7C,0x00,/*"S",51*/
0x04,0x44,0x7C,0x44,/*"T",52*/
0x00,0x7C,0x7C,0x00,/*"U",53*/
0x0C,0x30,0x30,0x0C,/*"V",54*/
0x1C,0x24,0x7C,0x0C,/*"W",55*/
0x6C,0x10,0x6C,0x00,/*"X",56*/
0x04,0x48,0x70,0x48,/*"Y",57*/
0x64,0x54,0x4C,0x00,/*"Z",58*/
0x00,0x00,0xFE,0x00,/*"[",59*/
0x00,0x06,0x38,0xC0,/*"\",60*/
0x00,0xFE,0x00,0x00,/*"]",61*/
0x00,0x01,0x00,0x01,/*"^",62*/
0x80,0x80,0x80,0x80,/*"_",63*/
0x00,0x00,0x01,0x00,/*"`",64*/
0x68,0x68,0x78,0x40,/*"a",65*/
0x00,0x7E,0x78,0x00,/*"b",66*/
0x70,0x48,0x48,0x00,/*"c",67*/
0x78,0x4A,0x7E,0x00,/*"d",68*/
0x00,0x78,0x78,0x00,/*"e",69*/
0x48,0x7E,0x4A,0x00,/*"f",70*/
0xF8,0xA8,0xB8,0xC8,/*"g",71*/
0x42,0x7E,0x78,0x00,/*"h",72*/
0x00,0x48,0x7A,0x40,/*"i",73*/
0x00,0x88,0xFA,0x00,/*"j",74*/
0x00,0x7E,0x38,0x00,/*"k",75*/
0x00,0x42,0x7E,0x40,/*"l",76*/
0x78,0x08,0x78,0x08,/*"m",77*/
0x48,0x78,0x78,0x00,/*"n",78*/
0x70,0x48,0x78,0x00,/*"o",79*/
0x00,0xF8,0xF8,0x00,/*"p",80*/
0x78,0xC8,0xF8,0x00,/*"q",81*/
0x48,0x78,0x48,0x00,/*"r",82*/
0x00,0x78,0x78,0x00,/*"s",83*/
0x08,0x7C,0x48,0x00,/*"t",84*/
0x00,0x78,0x78,0x00,/*"u",85*/
0x18,0x20,0x20,0x18,/*"v",86*/
0x18,0x68,0x78,0x08,/*"w",87*/
0x48,0x30,0x48,0x00,/*"x",88*/
0x88,0xD8,0x38,0x08,/*"y",89*/
0x00,0x78,0x78,0x00,/*"z",90*/
0x00,0x10,0xFE,0x82,/*"{",91*/
0x00,0x00,0xFF,0x00,/*"|",92*/
0x82,0xFE,0x10,0x00,/*"}",93*/
0x01,0x01,0x02,0x02,/*"~",94*/
};
...
void OLED_WriteData1(uint8_t Data,I2C_TYPE i2c_type,I2CX_Typedef i2cx)
{
	...
	JI2C_SendByte(Data,i2cx);	//依次发送Data的每一个数据
	JI2C_WaitAck(i2cx);
	JI2C_Stop(i2cx);	
}
...
void OLED_SetCursor(uint8_t Page, uint8_t X,I2C_TYPE i2c_type,I2CX_Typedef i2cx)
{
	OLED_WriteCommand(0x00 | (X&0X0F),i2c_type,i2cx);
	OLED_WriteCommand(0x10 | ((X&0XF0)>>4),i2c_type,i2cx);
	OLED_WriteCommand(0xB0 | Page,i2c_type,i2cx);
}
...
void OLED_Clear1(void)
{
	...
	{
		OLED_SetCursor(j,0,I2C1MODE,JI2C2);
		for(uint8_t i = 0; i < 128; i++)
		{
			OLED_DisplayBuf[j][i] = 0x00;
//			OLED_WriteData1(0x00,I2C1MODE,JI2C2);
		}
	}
}
...
void OLED_ShowChar1(int16_t Page, int16_t X, char Char,uint8_t fontsize)
{
	...
	if(fontsize == 6)
	{
		OLED_ShowImage1(Page,X,6,1,OLED_F6x8[Char - ' ']);
	}
	else if(fontsize == 8)
	{
		OLED_ShowImage1(Page,X,8,2,font8_16[Char - ' ']);
	}
}
...
void OLED_ShowString1(int16_t Page, int16_t X, char *String, uint8_t FontSize)
{
	...
	{
		OLED_ShowChar1(Page,X+i*FontSize,String[i],FontSize);
	}
}
...
void OLED_ShowImage1(int16_t Page, int16_t X, uint8_t Width, uint8_t Height, const uint8_t *Image)
{
	...
	{
//		OLED_SetCursor(Page+j,X,I2C1MODE,JI2C2);
		for(uint8_t i = 0; i < Width; i++)
		{
			OLED_DisplayBuf[j+Page][X+i] = Image[Width*j+i];
//			OLED_WriteData1(Image[Width*j+i],I2C1MODE,JI2C2);
		}
	}
}
...
void Show_Chinese(uint8_t Page,uint8_t X,char *Chinese)
{
	...
	for(uint8_t i = 0; Chinese[i] != '\0'; i++)
	{
		...
		{
			pChinese = 0;
			for(pIndex = 0; strcmp(image1[pIndex].Index,"") != 0; pIndex++)
			{
				if(strcmp(image1[pIndex].Index,SigleChinese) == 0)
				{
					break;
				}
			}
			OLED_ShowImage1(Page,X+((i+1)/2 -1)*32,32,4,(uint8_t*)image1[pIndex].Data);
		}
	}	
}
...
//void OLED_Updata(I2C_TYPE i2c_type,I2CX_Typedef i2cx)
//{
//	for(uint8_t j = 0; j<8; j++)
//	{
//		OLED_SetCursor(j, 0,i2c_type,i2cx);
