...
#define W25QXX_CS(bit)					GPIO_WriteBit(HSPI_CS_GPIO_Port,HSPI_CS_GPIO_Pin,(bit)?Bit_SET:Bit_RESET)
#define W25QXX_SCK(bit)					GPIO_WriteBit(HSPI_SCK_GPIO_Port,HSPI_SCK_GPIO_Pin,(bit)?Bit_SET:Bit_RESET)
#define W25QXX_ReadMISO()				GPIO_ReadInputDataBit(HSPI_MISO_GPIO_Port,HSPI_MISO_GPIO_Pin)
#define W25QXX_MOSI(bit)				GPIO_WriteBit(HSPI_MOSI_GPIO_Port,HSPI_MOSI_GPIO_Pin,(bit)?Bit_SET:Bit_RESET)
