...
//	AD9833_SetFrequencyQuick(AD9833_1.frequent,AD9833_OUT_MSB,SPI_MODE,JSPI1);//写输出频率1000.0Hz,输出方波
	...
	JI2C_Init(I2C1MODE,JI2C1);
	AD7746_Init(I2C1MODE,JI2C1);
	
	
//	if(AD774X_GetStatusFlag(RDY,I2C1MODE,JI2C1))
//	{
////		LED_On(CORE_LED);
//		AD7746.original = AD774X_GetCapacitance(I2C1MODE,JI2C1);
//		printf("Original:%d\r\n",AD7746.original);
//	}
	...
	MY_Menu_Init();
	Menu_Switch(BUTTON_Default,I2C1MODE,JI2C2);
	...
	{		
		if(TimeBaseGetFlag(BASE_100MS))
		{
			if(AD774X_GetStatusFlag(RDY,I2C1MODE,JI2C1))
			{
				AD7746.capicitance = AD7746_CapConvert(0,I2C1MODE,JI2C1);
				printf("Original:%fpf\r\n",AD7746.capicitance);
			}
