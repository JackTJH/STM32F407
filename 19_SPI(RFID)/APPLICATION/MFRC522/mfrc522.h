...
#define MFRCC_RST_GPIO_RCC				RCC_AHB1Periph_GPIOB
#define MFRCC_RST_GPIO_Port				GPIOB
#define MFRCC_RST_GPIO_Pin				GPIO_Pin_7

#define MFRCC_RST(bit)						GPIO_WriteBit(MFRCC_RST_GPIO_Port,MFRCC_RST_GPIO_Pin,(bit)?Bit_SET:Bit_RESET)
