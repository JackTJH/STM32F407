...
AT24CXX_Typedef AT24c02;

const uint8_t Tx_Buffer[] = "JackTJH@nuaa.edu.cnQWEWQEDEEWCEWCWECdsacxasccadedwewd";
...
//	JSPI_Init(SPI_MODE);	
//	MFRC522_Init(SPI_MODE);

	JI2C_Init(I2C1MODE,JI2C1);
//	AT24c02.double_wbuffer[0] = 3.256;
...
//	printf("E2PROM:%f\r\n",AT24c02.double_rbuffer[0]);
	...
	AT24CXX_WriteBuffer((uint8_t*)Tx_Buffer,0,BufferSize,I2C1MODE,JI2C1);
	AT24CXX_ReadBuffer ((uint8_t*)AT24c02.u8_rbuffer,8,BufferSize,I2C1MODE,JI2C1);
	printf("E2PROM:%s\r\n",AT24c02.u8_rbuffer);
