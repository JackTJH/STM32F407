...
extern My_Flash_Typedef My_Flash;
void ALARM_Interrupt_Init(void)
{
	...
	RTC_AlarmStructure.RTC_AlarmTime.RTC_Hours = My_Flash.ReadDataTemp[0];
	RTC_AlarmStructure.RTC_AlarmTime.RTC_Minutes = My_Flash.ReadDataTemp[1];
	RTC_AlarmStructure.RTC_AlarmTime.RTC_Seconds = My_Flash.ReadDataTemp[2];
